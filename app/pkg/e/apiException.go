...
func newAPIException(code int,msg string,data map[string]interface{},success bool) *APIException {
	return &APIException{
		Code:      code,
		Success:   success,
		Msg:       msg,
...
// 200
func ResponseJson(message string,data map[string]interface{},success bool) *APIException {
